...
nmap ,= :call Preserve("normal gg=G")
nmap ,$ :call Preserve("%s/\\s\\+$//e")
...
set mouse=a
set ruler
set runtimepath=~/.vim,~/.vim/plugins/fugitive,~/.vim/plugins/gundo,~/.vim/plugins/tabular,~/.vim/plugins/unimpaired,/usr/share/vim/vimfiles,/usr/share/vim/vim73,/usr/share/vim/vimfiles/after,~/.vim/plugins/tabular/after,~/.vim/after
set shiftwidth=4
set softtabstop=4
set tabstop=4
set viminfo='20,\"50
